...
本專案將半導體製程課程資料整理成可公開瀏覽的靜態互動複習網站。網站以繁體中文呈現，依 SMT 分堂建立「逐頁、逐重點、逐觀念」的考前複習筆記，目標是讓讀者不開原講義也能直接複習核心觀念、製程流程、圖表讀法、公式、老師強調、待確認標籤、flashcards 與互動測驗。
...
SMT-07 來源缺失，因此未建立分堂頁面，也未補寫未提供內容。公開網站總計包含 17 個分堂頁與 937 頁逐頁整理。
...
公開網站不包含原始 PDF、影片、錄音、完整逐字稿、處理中間檔、私人筆記、本機路徑或憑證。公開內容僅限重新整理後的靜態網頁、互動程式與自製示意圖。
...
- SMT-07 缺少來源資料。
- 部分頁面文字抽取偏短或以圖表為主，網站已標示「需人工確認」。
- 老師強調內容以轉錄線索輔助判讀；疑似誤聽者不直接標成必考。
- 網站不使用講義原圖或截圖，圖表內容以自製示意圖與文字說明呈現。
